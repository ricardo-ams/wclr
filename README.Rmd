...
This is an **alpha** version of the WCLR package. It is subject to many interface changes and bug fixes. However, it is mature enough to be downloaded and used in data fitting experiments.

## Installation

You can install the development version of WCLR from [GitHub](https://github.com/) with:
